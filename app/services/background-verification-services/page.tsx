...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.ontriq.com/services/background-verification-services',
  },
};
...
export default function BackgroundVerificationServicesPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Background Verification Services", "item": "https://www.ontriq.com/services/background-verification-services" },
    ],
  };
