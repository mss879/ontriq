...
export default function CriminalRecordCheckPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 4, "name": "Criminal Record Check", "item": "https://www.ontriq.com/services/bgv/criminal-record-check" },
    ],
  };
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200">
            <p className="text-slate-600">Criminal record checks are part of our <Link href="/services/bgv" className="text-[#0098F3] font-semibold hover:underline">background verification services</Link>.</p>
          </div>
