...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.ontriq.com/services/bgv/employment-verification',
  ...
  alternates: {
    canonical: 'https://www.ontriq.com/services/bgv/employment-verification',
  },
};
...
export default function EmploymentVerificationPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 4, "name": "Employment Verification", "item": "https://www.ontriq.com/services/bgv/employment-verification" },
    ],
  };
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="mt-12 p-6 rounded-2xl bg-slate-50 border border-slate-200">
            <p className="text-slate-600 mb-4">
              Employment history verification is part of our comprehensive <Link href="/services/bgv" className="text-[#0098F3] font-semibold hover:underline">background verification services</Link> package. Contact us to learn how we can help secure your hiring process.
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <Link href="/services/bgv/education-verification" className="p-5 rounded-2xl border border-slate-200 bg-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
