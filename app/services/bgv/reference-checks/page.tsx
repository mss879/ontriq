...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.ontriq.com/services/bgv/reference-checks',
    images: [{ url: 'https://www.ontriq.com/share-img.png', width: 1200, height: 630, alt: 'Ontriq Reference Checks' }],
  },
  alternates: { canonical: 'https://www.ontriq.com/services/bgv/reference-checks' },
};
...
export default function ReferenceChecksPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 4, "name": "Reference Checks", "item": "https://www.ontriq.com/services/bgv/reference-checks" },
    ],
  };
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200">
            <p className="text-slate-600">Reference checks are part of our <Link href="/services/bgv" className="text-[#0098F3] font-semibold hover:underline">background verification services</Link>.</p>
          </div>
