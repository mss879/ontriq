...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.ontriq.com/services/bgv/identity-address-verification',
  ...
  alternates: { canonical: 'https://www.ontriq.com/services/bgv/identity-address-verification' },
};
...
export default function IdentityAddressVerificationPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 4, "name": "Identity & Address Verification", "item": "https://www.ontriq.com/services/bgv/identity-address-verification" },
    ],
  };
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200">
            <p className="text-slate-600">Identity verification is part of our <Link href="/services/bgv" className="text-[#0098F3] font-semibold hover:underline">background verification services</Link>.</p>
          </div>
