    ...
    <>
      ...
      >
        ...
        <ul>
          ...
          <li><strong>Scope checks to the role.</strong> An entry-level hire rarely needs the full executive package. Matching the package to the role&mdash;Essential for entry-level positions, Professional for mid-level and specialist hires, Enterprise for executives and compliance-sensitive roles&mdash;keeps both the timeline and the budget proportionate. Our guide to <Link href="/resources/background-verification-cost-sri-lanka">background verification costs in Sri Lanka</Link> explains how these tiers are typically priced.</li>
