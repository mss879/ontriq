          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
            ...
            >
              ...
              <div className="relative flex h-full flex-col justify-between gap-10">
                <div className="max-w-2xl space-y-4">
                  ...
                  <p className="text-base text-slate-500 md:text-lg leading-relaxed text-justify">
            ...
            >
              <div className="absolute inset-0">
                <video
                  src="/globe-animation-optimized.mp4"
                  autoPlay
                  loop
                  muted
                  playsInline
                  ...
                  aria-hidden="true"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 via-white/70 to-orange-50/50"></div>
              </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:auto-rows-[minmax(0,1fr)]">
            ...
            >
              ...
              <div className="relative flex h-full flex-col gap-8 p-10">
                <div className="max-w-[420px] space-y-6 my-auto">
                  <h3 className="text-4xl font-semibold uppercase leading-tight sm:text-[42px]">Why Choose<br />Ontriq?</h3>
                  <p className="text-base text-white md:text-lg leading-relaxed text-justify">
                    We serve as a reliable extension of your team, designing scalable, cost-effective solutions that drive sustainable growth and deliver measurable results.
                  </p>
                </div>
