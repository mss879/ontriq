...
function SideItem({
              ...
              return (
                <button
                  type="button"
                  onClick={onClick}
                  className={`flex w-full items-center justify-center gap-2 rounded-2xl border px-3 py-3 text-xs font-semibold transition-colors sm:justify-start sm:gap-3 sm:px-4 sm:text-sm ${
                    active
              ...
              return (
                <div
                  ...
                  className={`relative overflow-hidden rounded-3xl border p-5 transition-colors ${
                    isOver ? 'border-[#F75834] bg-orange-50/70' : 'border-slate-200 bg-slate-100'
                  }`}
                >
                  <div
                    aria-hidden="true"
